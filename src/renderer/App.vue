<template>
    <main class="relative h-screen w-screen overflow-hidden" :class="{ animationsDisabled: 'disable-animations' }">
        <!-- Decoration -->
        <div
            class="gradient-ball absolute bottom-0 left-0 -z-10 aspect-square w-[90vw] translate-x-[-50%] translate-y-[50%] opacity-15"
        ></div>
        <div
            class="gradient-ball absolute right-0 top-0 -z-10 aspect-square w-[90vw] translate-x-[50%] translate-y-[-50%] opacity-15"
